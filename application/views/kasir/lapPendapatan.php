...
<body>
    ...
    <script>
        ...
        $('#lihat').click(() => {
            ...
            $.ajax({
                url: 'http://localhost/laundry/index.php/dataPendapatanKasir',
                method: 'POST',
                data: {
                    dari: $('#dari').val(),
                    sampai: $('#sampai').val(),
                    ...
                    for (let i = 0; i < data.transaksi.length; i++) {
                        ...
                        $('#detailPendapatan').append(`
                            <tr>
                                ...
                                <td style="text-align: center;">${data.transaksi[i].pendapatan}</td>
                            </tr>
                        `)
                    }
        ...
        $('#cetak').click((e) => {
            ...
            if (dari == '' && sampai == '') {
                ...
                window.location.href = `http://localhost/laundry/index.php/cetakLaporanPendapatanKasir/${dari}/${sampai}/${periode}`
            }
        })
    </script>
</body>
