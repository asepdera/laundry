...
<body>
    ...
    <script>
        ...
        setInterval(() => {
            $.ajax({
                url: 'http://localhost/laundry/index.php/ambilDataMemberBaruOwner',
                method: 'GET',
                dataType: 'JSON',
                success: (data) => {
                    $('#mbaru').empty()
            ...
            $.ajax({
                url: 'http://localhost/laundry/index.php/dataOwner?id_outlet=<?= $this->session->userdata('id_outlet') ?>',
                method: 'GET',
                dataType: 'JSON',
                success: (data) => {
                    $('#ubaru').empty()
                    ...
                    // console.log(data.pekerja.length)
                }
            })
