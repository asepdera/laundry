...
<body>
    ...
    <script>
        ...
        $('#lihat').click(() => {
            ...
            $.ajax({
                url: 'http://localhost/laundry/index.php/dataPendapatanOwner',
                method: 'POST',
                data: {
                    dari: $('#dari').val(),
                    sampai: $('#sampai').val(),
        ...
        $('#cetak').click((e) => {
            ...
            if (dari == '' && sampai == '') {
                ...
                window.location.href = `http://localhost/laundry/index.php/cetakLaporanPendapatanOwner/${dari}/${sampai}/${periode}`
            }
        })
    </script>
</body>
