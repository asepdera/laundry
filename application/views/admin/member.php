...
<body>
    <main class="main-content">
        ...
        <form action="<?= site_url('tambahMemberAdmin') ?>" method="post">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="alamat" class="form-control" autocomplete="off" required></input>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="number" name="telp" class="form-control" autocomplete="off" required></input>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        foreach ($member as $item) : $no++; ?>
                            <tr>
                                <td><?= $no ?></td>
                                <td><?= $item->nama ?></td>
                                <td style="max-width: 170px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><?= $item->alamat ?></td>
                                <td><?php
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo site_url("hapusMemberAdmin/$item->id") ?>" class="btn btn-danger hapus" onclick="return confirm('anda yakin akan menghapus data ini? data yang telah dihapus tidak akan bisa dikembalikan!')">
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <form action="<?php echo site_url('aksiEditMemberAdmin') ?>" method="post" id="form-edit">
                    ...
                    <div class="modal-body form-group">
                        ...
                        <div class="mt-3">
                            <label for="">Telepon:</label>
                            <input type="text" name="telp" class="form-control" id="edit_telp">
                        </div>
